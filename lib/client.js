 ...
 Void.ev.on('group-participants.update', async(anu) => {
                    ...
                    if (checkinfo) {
                        ...
                        if(/@pp/g.test(goodbye_messages)) {
                           let buttonMessage = {
                            ...
                            let buttons = [
                                { buttonId: `okedoh`, buttonText: { displayText: 'معوض' }, type: 1 }
                            ]
                            let buttonMessage = {
                                image: { url : ppUrl },
                                caption: `[ عملية تخفيض ]\n\nالأسم : @${num.split("@")[0]}\nالمنصب : عضو`,
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    for (let i of owner) {
                        Void.sendMessage(i + "@s.whatsapp.net", { text: `_شكراً لأختيارك بوت رايزل_\n\n_يمكنك رؤية الاوامر بكتابة  *.اوامر* او *.menu*_\n_موقعنا :_\n *https://solo.to/daemon-1*_\n_المطور: رايزل جورج_\n_الدعم:-  https://chat.whatsapp.com/EZe0MlgU0xo8GXtkCpqS0M_\n_ان وصلت لك هذه الرساله فمعناها ان البوت يعمل بدون اي مشاكل:` })
                    }
                }
